...
public class CustomUpdateDialog extends Dialog {
    ...
    private CustomUpdateDialog(Context context, int themeResId) {
        ...
        bt_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onCancelListener != null) {
                    onCancelListener.onClick(CustomUpdateDialog.this, v);
                }
            }
        });
        bt_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onConfirmListener != null) {
                    onConfirmListener.onClick(CustomUpdateDialog.this, v);
                }
            }
        });
    }
    ...
    public interface OnClickListener {
        void onClick(CustomUpdateDialog dialogCustom, View v);
    }
    ...
    public static class Builder {
        ...
        public CustomUpdateDialog create() {
            CustomUpdateDialog dialogCustom = new CustomUpdateDialog(context, R.style.Dialog);
